...
describe('Locale Middleware', function () {
    beforeEach(function () {
        ...
        config()->set('locale.supported', ['id', 'en', 'fr']);
    ...
    it(
        'uses application default locale when no locale source exists',
        function () {
    ...
    it(
        'falls back to default locale for unsupported browser locale',
        function () {
    ...
    it('uses locale from cookie', function () {
        $response = $this->withCookie('locale', 'fr')->get('/locale-test');
    ...
    it('ignores unsupported cookie locale', function () {
        $response = $this->withCookie('locale', 'jp')->get('/locale-test');
    ...
    it('uses authenticated user locale', function () {
        ...
        $response = $this->actingAs($user)->get('/locale-test');
