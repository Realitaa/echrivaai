...
const page = usePage();
const userRole = computed(() => props.role ?? (page.props.auth as any)?.user?.role ?? 'student');
    ...
    <div class="flex h-full flex-1 flex-col-reverse gap-6 lg:flex-row">
        ...
        <div class="flex-1 lg:basis-3/4">
            ...
            <ScrollArea class="h-[calc(100vh-16rem)]">
                <div class="space-y-3 pr-4">
                    <template v-if="tasks.data.length > 0">
                        <div
                            ...
                            :key="task.id"
                            class="group relative flex items-center gap-4 rounded-lg border bg-card p-4 shadow-sm transition-all hover:shadow-md hover:border-primary/30"
                        >
                            <!-- Icon -->
                            <Link
                ...
                <!-- Pagination -->
                <div class="mt-4 flex items-center justify-end space-x-2 pr-4" v-if="tasks.links && tasks.links.length > 3">
        ...
        <div class="lg:basis-1/4">
            <Card class="overflow-hidden sticky top-4">
                ...
                <CardContent class="pt-3 text-center space-y-3">
                    ...
                    <p v-if="classroom.description" class="text-sm text-muted-foreground line-clamp-3">
