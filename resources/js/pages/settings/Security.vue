...
<template>
    ...
    <div class="space-y-6">
        ...
        >
            ...
            <div class="grid gap-2">
                <Label for="password">{{ $t('security.password.new') }}</Label>
                <PasswordInput
                    id="password"
                    name="password"
                    class="mt-1 block w-full"
    ...
    <div v-if="canManageTwoFactor" class="space-y-6">
        <Heading
            ...
            :description="$t('security.2fa.description')"
        />
        ...
        >
            <p class="text-sm text-muted-foreground">
                {{ $t('security.2fa.help_disabled') }}
            </p>

            <div>
                <Button v-if="hasSetupData" @click="showSetupModal = true">
                    <ShieldCheck />{{ $t('security.2fa.continue') }}
                </Button>
                <Form
                    v-else
                    v-bind="enable.form()"
